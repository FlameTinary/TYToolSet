...
@interface TYPresentTransitionOne ()

@property (nonatomic, assign) TYPresentTransitionOneType type;
//高度
@property (nonatomic, assign) CGFloat height;

@end
@implementation TYPresentTransitionOne

+ (instancetype)transitionWithTransitionType:(TYPresentTransitionOneType)type height:(CGFloat)height{
    return [[self alloc] initWithTransitionType:type height:height];
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    switch (_type) {
        case TYPresentTransitionOneTypePresent:
            [self presentAnimation:transitionContext];
            break;
            
        case TYPresentTransitionOneTypeDismiss:
...
- (void)presentAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    toVC.view.frame = CGRectMake(0, containerView.frame.size.height, containerView.frame.size.width, _height);
